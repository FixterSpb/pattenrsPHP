...
use Model\Entity;
use Model\IdentityMap\UserMap;

class User
{

    private UserMap $identityMap;
    private bool $fetchComplete = false;

     public function __construct(){
         $this->identityMap = new UserMap();
     }
    /**
    ...
    {
        $user = $this->identityMap->getEntityById($id);
    ...
    {
        $user = $this->identityMap->getEntityByLogin($login);
        if (!is_null($user)) return $user;
